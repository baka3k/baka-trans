...
use commands::{
    ...
    close_look_help_window, close_overlay_window, delete_llm_profile,
    delete_local_translation_api_key, download_whisper_model, export_transcript,
    force_translate_boundary, get_app_status, get_huggingface_token_status,
    get_hy_mt_model_status, get_local_translation_config,
    get_transcript_snapshot, get_vieneu_runtime_status, get_whisper_model_dir, has_api_key,
    has_translation_api_key, install_hy_mt_model, install_vieneu_runtime, list_audio_devices,
    list_llm_profiles, list_local_tts_voices, list_whisper_models,
    local_translation_credential_status, look_help_status, open_look_help_window,
    save_huggingface_token,
    open_overlay_window, open_screen_recording_settings, overlay_status, pause_session,
    play_test_tone, preview_local_tts, restart_vieneu_runtime, resume_session,
    clear_huggingface_token, run_meeting_summary_agent, save_api_key, save_llm_profile,
    save_local_translation_api_key,
    ...
    test_translation_api_key, test_translation_engine, translation_credential_status,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            local_translation_credential_status,
